...
function commandCatalog(): array
{
    return [
        ...
        'commands' => [
            ...
            ['name' => 'mcp', 'module' => 'mcp', 'type' => 'diagnostic', 'read_only' => true, 'summary' => 'Check MCP server configuration files across common agent clients, secret hygiene, remote URLs, env references, and risky commands without starting servers.', 'example' => 'php devdoctor mcp --config=.mcp.json'],
