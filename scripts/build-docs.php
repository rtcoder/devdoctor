...
function commandCatalog(): array
{
    return [
        ...
        'commands' => [
            ...
            ['name' => 'mcp', 'module' => 'mcp', 'type' => 'diagnostic', 'read_only' => true, 'summary' => 'Check MCP server configuration files across common agent clients, secret hygiene, remote URLs, env references, supply-chain pins, optional project policies, and risky commands without starting servers.', 'example' => 'php devdoctor mcp --disallow-remote --allow-command=node,npx'],
            ...
            ['name' => 'version', 'module' => 'version', 'type' => 'utility', 'read_only' => true, 'summary' => 'Show the current DevDoctor version for humans or automation.', 'example' => 'php devdoctor version --format=json'],
