...
function commandCatalog(): array
{
    return [
        ...
        'commands' => [
            ...
            ['name' => 'mcp', 'module' => 'mcp', 'type' => 'diagnostic', 'read_only' => true, 'summary' => 'Check MCP server configuration files for agent tooling without starting servers.', 'example' => 'php devdoctor mcp --config=.mcp.json'],
