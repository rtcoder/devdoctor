...
it('ships release workflow and composite action metadata', function () {
    ...
    expect($action['runs']['using'])->toBe('composite')
        ...
        ->and($action['branding']['color'])->toBe('teal')
...
it('ships static documentation and pinned CI examples', function () {
    ...
    expect($docsCheck->successful())->toBeTrue($docsCheck->stderr)
        ...
        ->and(file_get_contents($root.'/docs/examples/github-actions.yml'))->toContain('v1.38.1')
        ->and(file_get_contents($root.'/docs/examples/gitlab-ci.yml'))->toContain('v1.38.1')
        ->and(file_get_contents($root.'/docs/examples/bitbucket-pipelines.yml'))->toContain('v1.38.1')
