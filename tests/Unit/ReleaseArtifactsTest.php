...
it('ships static documentation and pinned CI examples', function () {
    ...
    expect($docsCheck->successful())->toBeTrue($docsCheck->stderr)
        ...
        ->and(file_get_contents($root.'/docs/examples/github-actions.yml'))->toContain('v1.42.0')
        ->and(file_get_contents($root.'/docs/examples/gitlab-ci.yml'))->toContain('v1.42.0')
        ->and(file_get_contents($root.'/docs/examples/bitbucket-pipelines.yml'))->toContain('v1.42.0')
