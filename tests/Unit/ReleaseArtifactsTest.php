...
it('ships static documentation and pinned CI examples', function () {
    ...
    expect($docsCheck->successful())->toBeTrue($docsCheck->stderr)
        ...
        ->and(file_get_contents($root.'/docs/commands.json'))->toContain('"options"')
        ->and(file_get_contents($root.'/docs/commands.json'))->toContain('"display": "--baseline="')
        ->and(file_get_contents($root.'/docs/commands.json'))->toContain('"display": "--allow-command="')
        ...
        ->and(file_get_contents($root.'/docs/commands.html'))->toContain('data-search="ports diagnostic path')
        ->and(file_get_contents($root.'/docs/commands.html'))->toContain('baselines')
        ->and(file_get_contents($root.'/docs/commands.html'))->toContain('command-reference-list')
        ->and(file_get_contents($root.'/docs/commands.html'))->toContain('--large-file-threshold=10M')
        ->and(file_get_contents($root.'/docs/commands.html'))->toContain('--port=*')
        ...
        ->and(file_get_contents($root.'/docs/examples/github-actions.yml'))->toContain('v1.48.0')
        ->and(file_get_contents($root.'/docs/examples/gitlab-ci.yml'))->toContain('v1.48.0')
        ->and(file_get_contents($root.'/docs/examples/bitbucket-pipelines.yml'))->toContain('v1.48.0')
