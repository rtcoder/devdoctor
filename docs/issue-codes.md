...
Issue codes are stable identifiers intended for CI parsing, baselines, and future integrations. Messages may improve over time; automation should match codes.
